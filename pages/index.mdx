...
On a smaller scale, individuals must develop a responsibility and leadership. Smith and Sharma define three key elements that, once appropriately defined, attract leadership and responsibility <Citation id="smithResponsibility" />. This would grant autonomy to working teams, 

1. Focus: defined and clear goals for the business and team
2. Will: finding meaning and purpose in the work
3. Capability: adequately skilled team members, availability of resources
...
Appropriately kicking off new projects (with a new team) can significantly impact the perception team members have on the work ahead. By projecting ourselves forward and opening a conversation on the previously mentioned focus, will and capability, we're able to foster leadership within a team <Citation id="smithResponsibility" />. Concretely, addressing purpose, desired outcomes, values, roles and skills with the team we're more resilient to the issues that lie ahead.

By reflecting, we create a level playing field. We create openness within a group. By forcing teams to put our fears and anxieties on the table, individuals are able to relate to on another. We become more comfortable with sharing deep feelings. This reciprocity of sharing fears forms trust and with trust we're able to share work we feel insecure about too.
